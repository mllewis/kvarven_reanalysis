...
One effect - Srull & Wyer (1979) - has a massive original effect size (~3) that strongly influences the magnitude of the correlations with the original es. Here's what the correlations look like when you exclue this point. 
```{r}
wide_df_full %>%
  filter(id != 14) %>%
  select(-id) %>%
